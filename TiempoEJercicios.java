...
//		TimeZone.getTimeZone(canada);
		...
		System.out.println(horaCanada); //IMPRESION DE ESA HORA
		TimeZone.setDefault(TimeZone.getTimeZone("GMT+1")); // VUELVO A LA ZONA HORARIA DE ESPAÑA
		Date horaEspania= new Date();
		System.out.println(horaEspania); //COMPROBACION DE QUE LA ZONA HORARIA ES LA DE ESPAÑA
		...
		System.out.println(japo);
		
		
		///////////EJ 11////////////////////////////
		LocalTime HoraJaponesa=  LocalTime.now();
		System.out.println(HoraJaponesa);
		...
		LocalTime horaEspa= LocalTime.now();
		System.out.println(horaEspa);
		// sin usar un objeto timezone
		//TimeZone.setDefault(TimeZone.getTimeZone("GMT+1"));
		//la diferencia horaria es el intervalo de horas entre una zona 
		//y otra... 
		System.out.println(ChronoUnit.HOURS.between(HoraJaponesa, horaEspa));
